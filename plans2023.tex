...
\begin{titlepage}
    ...
    \vfill
    {\bfseries\Large
		Projetos e atividades para 2023\\
		\vskip2cm
...
Este é o planejamento para o ano de 2023, após meu retorno da licença para tratar de assuntos particulares. Este documento será oportunamente
atualizado para levar em consideração eventuais novas atividades a serem incorporadas por necessidade do CDTN e atividades de pesquisa
a serem iniciadas após minha experiência de dois anos como especialista e desenvolvedor HPC no \textit{Forschungzentrum Jülich}, na Alemanha.
\end{abstract}
