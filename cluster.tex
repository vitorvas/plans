...
Em 13/03/2019: O nó \texttt{CORAGEM} segue apresentando erros que levam a um reboot que não termina, deixando a máquina em estado "hang". Vitor e Daniel estão responsáveis pelo contato e forma de acionamento da garantia da DELL. Está 
...
Em 26/03/2019: o nó \texttt{CORAGEM} teve sua BIOS e o firmware do iDRAC atualizados. Todos os outros
nós tiveram o repositório \textit{DELL} adicionado e deverão também ser atualizados oportunamente. Nesta
mesma data o cluster teve de ser desligado para nova verificação do sistema elétrico.
