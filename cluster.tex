...
de simulações oferecidos pelo \textit{Slurm} e controlado pelo serviço \texttt{slurmdbd}\\ está funcional, apesar dos relatórios via \texttt{sacct} e 
\texttt{sreport} não estarem exibindo dados. Entretanto, os dados estão sendo 
